...
# TODO rename into buffer
        ...
        # pt être modifié après coup
        pb.sense = pu.LpMinimize
        ...
        if mode == SolvingMode.RcvBuffer.value:
            ...
            pb = problem.MpTcpProblem("Subflow congestion windows repartition", pu.LpMaximize)
